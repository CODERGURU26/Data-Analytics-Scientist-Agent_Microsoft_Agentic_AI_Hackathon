...
export type AnalysisResult = {
  ...
  data_quality: {
    ...
    missing_values: { column: string; missing_count: number; missing_pct: number }[]
    duplicate_records: number
    constant_columns: string[]
    outliers: { column: string; outlier_count: number; outlier_pct: number; method: string }[]
  ...
  ml_problem_detection: {
    problem_type: 'classification' | 'regression' | 'clustering' | 'forecasting'
